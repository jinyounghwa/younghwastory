...
function App() {
  ...
  return (
    <div className="App">
      ...
      위에 작성한것에 이어서 쓰는 부분이지만 조금 더 자신을 챙겼다면 어땠을까 라는 생각이 들었어요 올림픽 공원을 산책하면서 
      ...
      <p className='mb-4'>
      가장 좋았던 책은 <b>한입크기로 잘라먹는 리액트 였습니다.</b> 이 책 만큼 친절한 책은 없었습니다. 자세하게 설명한 책으로 리액트를 처음 시작한 사람에게 강력하게 추천합니다.
...
가장 나빴던 책은  <b>타입스크립트 리액트 Next.js로 배우는 실전 웹 애플리케이션 개발</b>입니다. 책의 예제를 시작조차 할 수 없었던 최초의 책이었습니다. 또한 이 책을 읽으면서 아마도 atomic design은 내 사전에 없다고 생각할것 같아요 UI를 나누는 것도 적당히 나누어야 한다고 생각했습니다.
      ...
      <p className='mb-4'>
      내년에는 스스로를 가장 먼저 챙기는 1년으로 생각할 것입니다. 일요일에는 나만을 위해 사용하는 시간을 가지도록 무언가를 하거나 여행이라도 짧게 다녀오려고 합니다. 여행은 미션을 수행하는 방식의 여행이 아닌 그냥 돌아다니면서 녹음기 달고 소리를 수집해서 들어보는 여행을 할지도 모르겠네요      </p>
      <p className='mb-4'>
